...
source /opt/ros/ros2_rust/install/setup.zsh
...
alias nv="nvim"
#alias .cur="/opt/cursor.appimage"
alias .cur='cd "$PWD" && /opt/cursor.appimage .'
alias dui='du -h --max-depth=1 | sort -hr'
alias carl='/opt/CARLA_0.9.15/./CarlaUE4.sh -quality-level=Low'
